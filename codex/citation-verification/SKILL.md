...
version: 0.1.0
metadata:
  short-description: Citation verification reference guide
---
...
**Special risk with AI-assisted writing**: AI-generated citations have approximately 40% error rate; every citation must be verified via web search.
...
- Search for the paper via web search each time a citation is needed
...
- Use web search to access the paper PDF
...
2. **Use web search to find** - Verify every citation through web search
...
✅ **Correct approach**:
- Search every citation with web search
...
**Core Principle**: Proactively verify every citation during the writing process using web search and Google Scholar.

**Key Steps**:
1. web search to find the paper
