...
言語非依存の検査は latex-paper-en のスクリプトを共用する(`SCRIPTS=~/.claude/skills/latex-paper-en/scripts`)。
...
| prose | である調の文章推敲・AIっぽさの除去 | `~/.claude/skills/rewrite-human/SKILL.md` を読み、学術文体のチェックリストとリライトルールを適用する |
